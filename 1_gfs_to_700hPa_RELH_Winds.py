...
cs1 = ax.contour(lons, lats, tmpc_700, clevs_700_tmpc, colors='tab:red',linewidths=2,
	linestyles='dashed', transform=datacrs)
ax.clabel(cs1, fmt='%d', fontsize=16)

# Plot contours of 700-hPa geopotential height in black, solid lines
clevs_700_hght = np.arange(0, 8000, 30)
cs2 = ax.contour(lons, lats, hght_700, clevs_700_hght, colors='black', linewidths=2,
	transform=datacrs)
ax.clabel(cs2, fmt='%d', fontsize=16)#'large')
